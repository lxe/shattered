// From http://shattered.io/static/shattered.pdf
...
const sha1_a = crypto.createHash('sha1').update(Buffer.from(prefix.concat(a))).digest('hex')
const sha1_b = crypto.createHash('sha1').update(Buffer.from(prefix.concat(b))).digest('hex')

console.log(sha1_a, sha1_b);
